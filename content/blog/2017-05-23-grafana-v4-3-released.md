+++
title = "Grafana 4.3 Release"
author = "daniellee"
date = "2017-05-23"
keywords = ["Grafana", "Blog", "v4.3"]
cover_image = "/assets/img/blog/v4/heatmap.jpg"
cover_opacity = "0.6"
cover_blur = "1px"
description = "Grafana 4.3 Release Highlights"
+++

Grafana v4.3 is now [available for download](https://grafana.com/grafana/download).
...
A new [Dashes option](http://docs.grafana.org/features/panels/graph/#series-specific-overrides) has been added to Series overrides in the Graph Panel.

![](/assets/img/blog/v4/graph_dashed_line.png)
...
![](/assets/img/blog/v4/alert_annotation.png)
